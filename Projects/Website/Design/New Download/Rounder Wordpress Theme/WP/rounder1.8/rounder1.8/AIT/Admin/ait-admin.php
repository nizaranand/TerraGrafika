...
function aitGenerateAdminMenu($config, $brandingOptions)
{
	...
	if(isset($GLOBALS['showAdmin']['website_settings']) == false){
		$GLOBALS['showAdmin']['website_settings'] = "enabled";
	}
	...
	if(!@$GLOBALS['aitDisableBranding']){
		if(isset($GLOBALS['showAdmin']['branding']) == false){
			$GLOBALS['showAdmin']['branding'] = "enabled";
		}
	...
	if(isset($GLOBALS['showAdmin']['skins']) == false){
		$GLOBALS['showAdmin']['skins'] = "enabled";
	}
	...
	if(isset($GLOBALS['showAdmin']['backup']) == false){
		$GLOBALS['showAdmin']['backup'] = "enabled";
	}
