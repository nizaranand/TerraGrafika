 ...
 */
	function Events_Widget () {
		...
		/* Create the widget */
		$this->WP_Widget('events-widget', __('Theme &rarr; All Events', 'ait'), $widget_ops);
	}
...
function form ( $instance ) {
    ...
    <p>
        <label for="<?php echo $this->get_field_id( 'event_maximum' ); ?>"><?php echo __( 'Displayed events', 'ait' ); ?>:</label>
