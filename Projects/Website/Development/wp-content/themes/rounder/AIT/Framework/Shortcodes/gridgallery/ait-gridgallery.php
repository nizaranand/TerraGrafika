...
function ait_gridgallery( $params ) {
  ...
  if($category == '0'){
    ...
    foreach($categories as $cat){
      ...
      $args = array( 'post_type' => 'ait-grid-portfolio', 'orderby' => 'menu_order', 'order' => 'ASC', 'numberposts' => 500, 'tax_query' => array( array( 'taxonomy' => 'ait-grid-portfolio-category', 'field' => 'slug', 'terms' => $cat) ) );
    	//$args = array( 'post_type' => 'ait-grid-portfolio', 'orderby' => 'menu_order', 'order' => 'ASC', 'numberposts' => 500, 'category' => $cat);
